...
uint32_t crc32_combine (uint32_t crcA, uint32_t crcB, size_t lengthB); // 0
...
uint32_t crc32_16bytes_prefetch(const void* data, size_t length, uint32_t previousCrc32, size_t prefetchAhead); // 0, 256
#endif
